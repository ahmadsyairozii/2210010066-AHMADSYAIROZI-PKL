...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            header('Location: header-pegawai.php');
            exit;
        } else {
...
<html lang="en">
<head>
    <title>Login Pegawai Bidang PPKLH</title>
    <link href="css/bootstrap.min.css" rel="stylesheet">

    <style>
        body {
            background: linear-gradient(135deg, #B0E0E6, #C71585);
            height: 100vh;
            display: flex;
...
<body>
    ...
    <div class="login-card">
        <h3 class="login-title">Login Pegawai Bidang PPKLH</h3>
